...
<template>
    <div class="pt-4 bg-white sm:pt-10 lg:pt-12">
        <footer class="px-4 mx-auto max-w-screen-2xl md:px-8">
            <div
                class="flex flex-col items-center justify-between gap-4 py-6 border-t border-b md:flex-row"
            >
                <!-- nav - start -->
                <nav
            ...
            <div class="py-8 text-sm text-center text-gray-400">
